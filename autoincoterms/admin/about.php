...
/**
 * \file    autoincoterms/admin/about.php
 * \ingroup autoincoterms
 * \brief   About page of module autoincoterms.
 */
...
// Translations
$langs->loadLangs(array("errors", "admin", "autoincoterms@autoincoterms"));
...
llxHeader('', $langs->trans($title), $help_url, '', 0, 0, '', '', '', 'mod-autoincoterms page-admin_about');
